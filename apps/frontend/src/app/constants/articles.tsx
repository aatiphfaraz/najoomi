...
export const articles: Article[] = [
    {
        ...
        faqs: [
            {
                ...
                answer: "No. Niyyah lives in the heart. You don’t need to say it verbally unless it’s part of a specific act like salah.",
            },
            {
                question: "Can I have multiple intentions for one act?",
                answer: "Yes! For example, visiting a sick person could be done out of love, reward, and to comfort them—all in one.",
            },
            {
        ...
        contentBody: (
            <>
                ...
                <p>Niyyah (نِيَّة) means intention or purpose in Arabic. It refers to the inner resolve to perform an act sincerely for the sake of Allah ﷻ. It lives in the heart—no need to speak it aloud. It’s what turns ordinary actions into acts of worship (ibadah).</p>
                ...
                <blockquote className="border-l-4 border-[#fde68a] pl-4 my-4 text-[#b6894a] italic text-center">“Actions are judged by intentions.”<br />— Prophet Muhammad ﷺ (Bukhari &amp; Muslim)</blockquote>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    <div className="flex items-center bg-[#f5f3ea] rounded-lg shadow p-4 border-l-4 border-[#fde68a]">
                        ...
                        <div>
                            ...
                            <div className="text-[#b6894a] italic">“I drink to care for the body Allah has given me.”</div>
                        </div>
                    </div>
                    <div className="flex items-center bg-[#f5f3ea] rounded-lg shadow p-4 border-l-4 border-[#fde68a]">
                        <span className="mr-3 text-xl sm:text-2xl">🍲</span>
                        <div>
                            ...
                            <div className="text-[#b6894a] italic">“I prepare meals to bring love and barakah to my home.”</div>
                        </div>
                    </div>
                    <div className="flex items-center bg-[#f5f3ea] rounded-lg shadow p-4 border-l-4 border-[#fde68a]">
                        <span className="mr-3 text-xl sm:text-2xl">📚</span>
                        <div>
                            ...
                            <div className="text-[#b6894a] italic">“I work to earn halal income and benefit others.”</div>
                        </div>
                    </div>
                    <div className="flex items-center bg-[#f5f3ea] rounded-lg shadow p-4 border-l-4 border-[#fde68a]">
                        <span className="mr-3 text-xl sm:text-2xl">🤝</span>
                        <div>
                            ...
                            <div className="text-[#b6894a] italic">“I do this to please Allah and spread kindness.”</div>
                        </div>
                    </div>
                </div>
                ...
                <ol className="list-decimal pl-6 mb-4">
                    <li>Mental Clarity – You eliminate distractions by aligning actions with purpose.</li>
                    <li>Stronger Relationship with Allah – You involve your faith in every step.</li>
                    <li>Consistency in Good Deeds – You stay committed because your purpose is higher.</li>
                </ol>
                <h3 className="text-lg sm:text-xl mt-6 mb-2 text-[#15577a] font-semibold">How Can I Make Niyyah Part of My Routine?</h3>
                <ul className="list-disc pl-6 mb-4">
                    <li><b>Start your day with a heartfelt dua:</b> <span className="italic">“Ya Allah, guide my actions today to please You and bring barakah.”</span></li>
                    <li><b>Pause before any task:</b> Ask yourself: <span className="italic">“Am I doing this for Allah’s pleasure or just for myself?”</span></li>
                    <li><b>Set Niyyah-Based Goals:</b> Instead of: <span className="italic">Finish homework</span> <br />Try: <span className="italic">Learn this to help others with what I gain, for Allah’s sake.</span></li>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-4">
                    <div className="flex-1 bg-gradient-to-br from-[#fde68a] to-[#fffbe6] rounded-lg shadow p-4 flex items-center">
                        ...
                        <div>
                            ...
                            <div className="text-[#b6894a] italic">“Ya Allah, make today full of barakah.”</div>
                        </div>
                    </div>
                    <div className="flex-1 bg-gradient-to-br from-[#fde68a] to-[#fffbe6] rounded-lg shadow p-4 flex items-center">
                        <span className="mr-3 text-xl sm:text-2xl">🌞</span>
                        <div>
                            ...
                            <div className="text-[#b6894a] italic">“I renew my intention to stay mindful.”</div>
                        </div>
                    </div>
                    <div className="flex-1 bg-gradient-to-br from-[#fde68a] to-[#fffbe6] rounded-lg shadow p-4 flex items-center">
                        <span className="mr-3 text-xl sm:text-2xl">🌙</span>
                        <div>
                            ...
                            <div className="text-[#b6894a] italic">“Did I live today with intention?”</div>
                        </div>
                    </div>
                </div>
                ...
                <p>Niyyah is more than a religious formality—it’s a spiritual compass. At Najoomi, we believe true healing starts from within, and a sincere intention is the first step to transforming your thoughts, actions, and life.</p>
                <blockquote className="border-l-4 border-[#fde68a] pl-4 my-4 text-[#b6894a] italic text-center">“Indeed, Allah does not look at your appearance or wealth, but rather He looks at your hearts and your intentions.”<br />— Prophet Muhammad ﷺ</blockquote>
    ...
    },
    {
        ...
        contentBody: (
            <>
                ...
                <p>Stress, anxiety, and emotional pain are common struggles in modern life—but they are not without remedy. Islam offers more than temporary relief; it provides a path to lasting peace rooted in remembrance, trust in Allah ﷻ, and timeless spiritual tools.</p>
                <blockquote className="border-l-4 border-[#fde68a] pl-4 my-4 text-[#b6894a] italic text-center">“Verily, in the remembrance of Allah do hearts find rest.”<br />— Surah Ar-Ra’d (13:28)</blockquote>
                <h3 className="text-lg sm:text-xl mt-6 mb-2 text-[#15577a] font-semibold">Dhikr: The Daily Antidote to Anxiety</h3>
                <p><span className="font-semibold">Dhikr (ذِكْر)</span>—the remembrance of Allah—is a powerful spiritual practice that quiets the mind and softens the heart.</p>
                <div className="mb-4">
                    <div className="font-semibold text-[#15577a] mb-2 flex items-center">
                        <span className="mr-2 text-lg sm:text-xl">📿</span> Daily Dhikr for a Peaceful Heart
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="flex items-center bg-[#f5f3ea] rounded-lg shadow p-4 border-l-4 border-[#fde68a]">
                            <span className="mr-3 text-xl sm:text-2xl">🕊️</span>
                            <div>
                                <div className="font-semibold text-[#15577a]">Ya Salaam – O Source of Peace</div>
                        ...
                        <div className="flex items-center bg-[#f5f3ea] rounded-lg shadow p-4 border-l-4 border-[#fde68a]">
                            <span className="mr-3 text-xl sm:text-2xl">💗</span>
                            <div>
                                <div className="font-semibold text-[#15577a]">Ya Rahman – O Most Merciful</div>
                ...
                <div className="mb-4">
                    <div className="font-semibold text-[#15577a] mb-2 flex items-center">
                        <span className="mr-2 text-lg sm:text-xl">📘</span> Verses for the Anxious Soul
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div className="bg-[#f5f3ea] rounded-lg shadow p-4 flex flex-col items-center border-t-4 border-[#fde68a]">
                            ...
                            <div className="text-[#b6894a] italic text-center mb-1">“Your Lord will give you, and you will be satisfied.”</div>
                        ...
                        <div className="bg-[#f5f3ea] rounded-lg shadow p-4 flex flex-col items-center border-t-4 border-[#fde68a]">
                            ...
                            <div className="text-[#b6894a] italic text-center mb-1">“Indeed, with hardship comes ease.”</div>
                ...
                <div className="mb-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex items-center bg-[#f5f3ea] rounded-lg shadow p-4 border-l-4 border-[#fde68a]">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-[#15577a]">“Zamzam is for whatever it is drunk for.” – Ibn Majah</div>
                        </div>
                    </div>
                    <div className="flex items-center bg-[#f5f3ea] rounded-lg shadow p-4 border-l-4 border-[#fde68a]">
                        <span className="mr-3 text-xl sm:text-2xl">🌱</span>
                        <div>
                            ...
                            <div className="text-xs text-[#15577a]">“It is a cure for every disease except death.” – Bukhari</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mb-4">
                    <div className="font-semibold text-[#15577a] mb-2 flex items-center">
                        <span className="mr-2 text-lg sm:text-xl">🧘</span> Duas to Calm the Heart
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="bg-[#f5f3ea] rounded-lg shadow p-4 flex flex-col border-l-4 border-[#fde68a]">
                            ...
                            <div className="text-[#b6894a] italic mb-1">“Allahumma inni a’udhu bika minal-hammi wal-huzni...”</div>
                        ...
                        <div className="bg-[#f5f3ea] rounded-lg shadow p-4 flex flex-col border-l-4 border-[#fde68a]">
                            ...
                            <div className="text-[#b6894a] italic mb-1">“La hawla wa la quwwata illa billah”</div>
                ...
                <p>Stress and anxiety may be part of life—but so is healing. Through dhikr, dua, Quranic reflection, and Prophetic wellness, you can reconnect with your inner calm.</p>
                <blockquote className="border-l-4 border-[#fde68a] pl-4 my-4 text-[#b6894a] italic text-center">“And whoever puts their trust in Allah—He will suffice him.”<br />— Surah At-Talaq (65:3)</blockquote>
                {/* Decorative Islamic/Magical Touches */}
                <div className="flex justify-center my-6">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-2">
                        <path d="M24 4a20 20 0 100 40 20 20 0 000-40zm0 36a16 16 0 110-32 16 16 0 010 32z" fill="#fde68a" />
        ...
        faqs: [
            {
                ...
                answer: "Ilm-e-Adad is the Islamic science of numerology that assigns numerical values to Arabic letters. It’s used to gain spiritual insight into personality traits, destiny paths, and compatibility in relationships, especially in Nikah (marriage).",
            },
            {
            ...
            },
            {
                ...
                answer: "A low compatibility score is not a verdict. It's a signal for awareness and adjustment. With prayer, understanding, and effort, any marriage can thrive. Always seek Allah’s guidance through Istikhara and sincere dua.",
            },
            {
        ...
        contentBody: (
            <>
                ...
                <p>Nikah (marriage) is a sacred contract in Islam rooted in love, mercy, and tranquility. Beyond emotional connection and shared values, spiritual harmony plays a vital role in long-term marital success.<br />
                    <span className="font-semibold">Ilm-e-Adad</span>—an ancient form of Islamic numerology—offers deep insights into relationship dynamics using names, birth dates, and energy patterns. At Najoomi, we use this spiritual tool to help couples explore compatibility with divine perspective.</p>
                <div className="flex justify-center my-6">
                    <div className="relative bg-white border border-[#fde68a] rounded-xl sm:rounded-2xl shadow-lg flex flex-col items-center w-full max-w-full sm:max-w-xl md:max-w-2xl min-h-[140px] sm:min-h-[160px] md:min-h-[180px] px-4 py-5 sm:px-8 sm:py-6 md:px-10 md:py-7 overflow-hidden">
                        ...
                        <div className="w-full bg-[#f9fafb] border border-[#fde68a]/40 rounded-lg px-3 py-3 mt-1 mb-2 sm:px-6 sm:py-4">
                            <div className="text-base text-gray-700 text-center">Name <span className="mx-1">→</span> Arabic Letters <span className="mx-1">→</span> Number Values <span className="mx-1">→</span> Personality & Compatibility Profile</div>
                        </div>
                        {/* Decorative sparkle */}
                ...
                <p>Marriage is more than love—it is spiritual alignment. Even with affection and good intentions, subtle energetic mismatches can cause tension.</p>
                ...
                <p className="text-xs italic text-gray-500">Note: This tool enhances understanding—it does not replace du’a, Istikhara, or communication.</p>
                <div className="flex justify-center my-6">
                    <div className="relative bg-white border border-[#b6894a] rounded-xl sm:rounded-2xl shadow-lg flex flex-col items-center w-full max-w-full sm:max-w-xl md:max-w-2xl min-h-[140px] sm:min-h-[160px] md:min-h-[180px] px-4 py-5 sm:px-8 sm:py-6 md:px-10 md:py-7 overflow-hidden">
                        ...
                        <div className="w-full bg-[#f9fafb] border border-[#b6894a]/40 rounded-lg px-3 py-3 mt-1 mb-2 sm:px-6 sm:py-4">
                            <div className="text-base text-gray-700 text-center mb-2 font-medium">Bride ↔ Groom | Name Number | Life Path | Compatibility Score</div>
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-2">
                                <span className="text-blue-500 bg-blue-50 rounded px-3 py-2 text-sm flex items-center gap-2 justify-center">🔵 <span>Strong</span></span>
                                <span className="text-yellow-600 bg-yellow-50 rounded px-3 py-2 text-sm flex items-center gap-2 justify-center">🟡 <span>Neutral</span></span>
                                <span className="text-red-500 bg-red-50 rounded px-3 py-2 text-sm flex items-center gap-2 justify-center">🔴 <span>Challenging</span></span>
                            </div>
                        </div>
                        {/* Decorative sparkle */}
                        <svg className="absolute top-4 right-6 w-6 h-6 text-[#fde68a] opacity-60" fill="currentColor" viewBox="0 0 20 20"><polygon points="10,1 12,7 19,8 13.5,12.5 15,19 10,15.5 5,19 6.5,12.5 1,8 8,7" /></svg>
                ...
                <ol className="list-decimal ml-6 my-2">
                    <li><b>Name Number Calculation:</b> Each Arabic letter has a numeric value. Totals are calculated for a person’s full name.</li>
                    ...
                    <div className="relative bg-white border border-[#fde68a] rounded-xl sm:rounded-2xl shadow-lg flex flex-col items-center w-full max-w-full sm:max-w-xl md:max-w-2xl min-h-[140px] sm:min-h-[160px] md:min-h-[180px] px-4 py-5 sm:px-8 sm:py-6 md:px-10 md:py-7 overflow-hidden">
                        ...
                        <div className="w-full bg-[#f9fafb] border border-[#fde68a]/40 rounded-lg px-3 py-3 mt-1 mb-2 sm:px-6 sm:py-4">
                            <ul className="text-base text-gray-700 list-disc ml-6 text-left space-y-3">
                                <li><b>"Rabbana hab lana min azwajina wa dhurriyyatina qurrata a’yunin..."</b> <br />
                                    <span className="block">“Our Lord, grant us from our spouses and offspring comfort to our eyes…” <span className="text-xs">(Surah Al-Furqan 25:74)</span></span>
                                </li>
                                <li><b>Surah Ar-Rum (30:21):</b> “He placed affection and mercy between you.”</li>
                                <li><b>Surah Al-Baqarah (2:187):</b> “They are garments for you, and you are garments for them.”</li>
                            </ul>
                        </div>
                        {/* Decorative sparkle */}
                        <svg className="absolute top-4 right-6 w-6 h-6 text-[#fde68a] opacity-60" fill="currentColor" viewBox="0 0 20 20"><polygon points="10,1 12,7 19,8 13.5,12.5 15,19 10,15.5 5,19 6.5,12.5 1,8 8,7" /></svg>
                ...
                <blockquote className="border-l-4 border-[#fde68a] pl-4 my-4 text-[#b6894a] italic text-center">“And He created for you from yourselves mates that you may find tranquility in them.”<br />— Surah Ar-Rum (30:21)</blockquote>
                {/* Decorative Islamic/Magical Touches */}
                <div className="flex justify-center my-6">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-2">
                        <path d="M24 4a20 20 0 100 40 20 20 0 000-40zm0 36a16 16 0 110-32 16 16 0 010 32z" fill="#fde68a" />
    ...
    },
    {
        ...
        summary: "Explore 7 clear signs of a spiritually healthy mind in Islam, with practical tips and Qur’anic insights to cultivate inner peace and resilience.",
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: "Two key verses are: Surah Ar-Ra’d 13:28: ‘In the remembrance of Allah do hearts find rest.’ and Surah Al-Inshirah 94:6: ‘With hardship comes ease.’ These verses offer peace and hope during emotional or mental distress.",
            },
            {
                question: "Why is spiritual health more important than emotional calm alone?",
                answer: "Emotional calm can be temporary, but spiritual health offers lasting peace. A heart connected to Allah is better equipped to handle life’s challenges, find purpose, and remain steady in trials.",
            },
            {
                question: "Is forgiveness a sign of spiritual strength in Islam?",
                answer: "Yes. Islam teaches that forgiving others—even when wronged—is a sign of a strong, spiritually mature person. The Prophet ﷺ said that true strength is shown by one who controls anger and forgives for Allah’s sake.",
            },
            {
        ...
        contentBody: (
            <>
                ...
                <p className="mb-3">A spiritually healthy mind in Islam is not just about being stress-free—it's about aligning your heart (<b>qalb</b>), actions, and thoughts with <b>Tawheed</b> (Oneness of Allah). It involves peace, emotional clarity, and the ability to face trials with faith, gratitude, and reflection.</p>
                <blockquote className="border-l-4 border-[#fde68a] pl-4 my-4 text-[#b6894a] italic text-center">
                    “The Day when neither wealth nor children will benefit [anyone], but only one who comes to Allah with a sound heart (qalb salim).”<br />
                ...
                <ol className="list-decimal ml-6 my-2 space-y-2">
                    <li><b>🤲 Tawakkul – Trusting Allah in All Matters:</b> You remain calm during uncertainty, believing Allah’s plan is better than your own.</li>
                    <li><b>🌙 Daily Dhikr – Finding Peace in Remembrance:</b> Reciting SubhanAllah, Alhamdulillah, and Ya Salaam becomes your emotional anchor.</li>
                    <li><b>🕊️ Forgiveness and Letting Go:</b> You no longer hold grudges. You forgive as a path to inner freedom, reflecting prophetic character.<br /><span className="text-xs text-gray-500">“The strong person is not the one who overcomes others by strength, but the one who controls himself when angry.” — Sahih al-Bukhari</span></li>
                    <li><b>💡 Gratitude in Difficulty:</b> You replace complaints with thanks—even in adversity—trusting there is good in every test.</li>
                    <li><b>📿 Self-Reflection (Muhasaba):</b> You take time to assess your actions, thoughts, and intentions regularly.</li>
                    <li><b>🚫 Avoidance of Negative Thinking:</b> You avoid gossip, envy, and pessimism—choosing kindness, optimism, and silence.</li>
                    <li><b>📘 Emotion Guided by Revelation:</b> You manage anger, sadness, and joy with Quranic teachings and prophetic manners.</li>
                </ol>
                ...
                <ul className="list-disc ml-6 my-2 space-y-2">
                    <li><b>🧘 Mindful Salah:</b> Salah isn’t just obligation—it’s your daily reset button for inner peace.</li>
                    <li><b>📖 Recite Calming Quranic Verses:</b> <br />
                        <span className="text-[#15577a]">Surah Ar-Ra’d 13:28:</span> “In the remembrance of Allah do hearts find rest.”<br />
                        <span className="text-[#15577a]">Surah Al-Inshirah 94:6:</span> “With hardship comes ease.”
                    </li>
                    <li><b>🤲 Make Duas for Peaceful Soul:</b> “Allahumma inni as’aluka nafsan mutmainnah...”<br /><span className="text-xs">(O Allah, grant me a tranquil and content soul.)</span></li>
                    <li><b>🌿 Follow Prophetic Wellness Habits:</b> Use black seed and honey for body-mind balance; sleep early and rise early—reflecting the Sunnah lifestyle.</li>
                </ul>
                ...
                <p>A spiritually healthy mind is not free from problems—it’s equipped to face them with patience, clarity, and divine trust.<br />At Najoomi, we help guide your journey toward mental and spiritual alignment—so your heart finds peace in the remembrance of Allah ﷻ.</p>
                <blockquote className="border-l-4 border-[#fde68a] pl-4 my-4 text-[#b6894a] italic text-center">
                    “Indeed, those who believe and whose hearts find comfort in the remembrance of Allah—surely in the remembrance of Allah do hearts find peace.”<br />— Surah Ar-Ra’d 13:28
                </blockquote>
